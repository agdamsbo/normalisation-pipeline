...
1.  Follow the same steps [as above](#too-much) to add non-brain area to exclude from the brain mask. Save the new brain mask and then invert the modified inverted brain mask again:
